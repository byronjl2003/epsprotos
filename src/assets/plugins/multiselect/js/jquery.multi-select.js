...
! function($) {
    ...
    MultiSelect.prototype = {
        ...
        init: function() {
            ...
            var selectedValues = ms.find('option:selected')
                .map(function() {
                    return $(this).val();
                })
                .get();
        ...
        'generateLisFromOption': function(option, index, $container) {
            ...
            var selectableLi =
                $('<li ' + attributes + '><span>' +
                    that.escapeHTML($option.text()) + '</span></li>'),
                selectedLi = selectableLi.clone(),
                value = $option.val(),
                elementId = that.sanitize(value);

            selectableLi.data('ms-value', value)
                .addClass('ms-elem-selectable')
                .attr('id', elementId + '-selectable');

            selectedLi.data('ms-value', value)
            ...
            if ($optgroup.length > 0) {
                var optgroupLabel = $optgroup.attr('label'),
                    ...
                    $selectableOptgroup =
                    that.$selectableUl.find('#optgroup-selectable-' + optgroupId),
                    $selectionOptgroup =
                    that.$selectionUl.find('#optgroup-selection-' + optgroupId);
                ...
                if ($selectableOptgroup.length === 0) {
                    ...
                    if (that.options.selectableOptgroup) {
                        $selectableOptgroup.find('.ms-optgroup-label')
                            .on('click', function() {
                        ...
                        $selectionOptgroup.find('.ms-optgroup-label')
                            .on('click', function() {
        ...
        'destroy': function() {
            ...
            this.$element.css('position', '')
                .css('left', '') this.$element.removeData('multiselect');
        },
        ...
        'select': function(value, method) {
            ...
            if (selectables.length > 0) {
                ...
                var selectableOptgroups =
                    that.$selectableUl.children('.ms-optgroup-container');
                if (selectableOptgroups.length > 0) {
                    ...
                    var selectionOptgroups =
                        that.$selectionUl.children('.ms-optgroup-container');
        ...
        'select_all': function() {
            ...
            this.$selectableUl.find('.ms-elem-selectable')
                .filter(':not(.' + this.options.disabledClass + ')')
                .addClass('ms-selected')
                .hide();
            this.$selectionUl.find('.ms-optgroup-label').show();
            this.$selectableUl.find('.ms-optgroup-label').hide();
            this.$selectionUl.find('.ms-elem-selection')
                .filter(':not(.' + this.options.disabledClass + ')')
                .addClass('ms-selected')
                .show();
            this.$selectionUl.focus();
    ...
    $.fn.multiSelect = function() {
        ...
        return this.each(function() {
            var $this = $(this),
                ...
                options = $.extend({}, $.fn.multiSelect.defaults, $this.data(),
